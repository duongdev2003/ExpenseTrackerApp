    ...
    function renderNavBar() {
        return (
            <View
                ...
                <TouchableOpacity style={{justifyContent: 'center', width: 50}} onPress={() => console.log('Go Back')}>
                    <Image
                ...
                <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Text
                        style={{
                            marginLeft: SIZES.base,
                            color:
                                selectedCategory && selectedCategory.name == item.name ? COLORS.white : COLORS.primary,
                            ...FONTS.h3,
                        }}>
                        {item.name}
                    </Text>
